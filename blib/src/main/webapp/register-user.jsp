...
<header>
	...
	<form action="<%= request.getContextPath() %>/users/register" method="post">
		...
		<div class="mb-3">
		  ...
		  <input type="text" name="field-username" class="form-control" id="name">
		</div>
		
		<div class="mb-3">
		  <label for="name" class="form-label">Nova senha</label>
		  <input type="password" name="field-password" class="form-control" id="name">
		</div>
		...
		<div class="mb-3">
		  ...
		  <select name="field-type" class="form-select" aria-label="Default select example" id="price">
		    <option selected value="1">Outro</option>
