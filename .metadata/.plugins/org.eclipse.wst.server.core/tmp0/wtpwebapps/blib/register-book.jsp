...
<header>
  ...
  <div class="alert alert-danger" role="alert"
	...
	<form action="<%= request.getContextPath() %>/books/register" method="post">
		...
		<div class="mb-3">
		  ...
		  <input type="text" name="field-date" class="form-control" id="price">
		</div>
		
		<div class="mb-3">
		  <label for="price" step='0.01' class="form-label">Autor</label>
		  <input type="text" name="field-author" class="form-control" id="price">
		</div>
